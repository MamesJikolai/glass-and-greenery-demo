...
export default function Home() {
    ...
    return (
        <PageWrapper
            isLanding={true}
            title="Welcome to Glass & Greenery"
                    ...
                    <div className="flex flex-row flex-wrap justify-center text-left md:text-center gap-y-8 md:gap-x-32 md:gap-y-16">
                        <div className="w-fit md:w-[500px]">
                            ...
                            <p className="text-[16px] md:text-[24px]">
                                At Glass & Greenery, we believe building a
                                terrarium is more than a hobby—it's a moment of
                                stillness in a fast-moving world. Every kit and
                                workshop is designed to help you slow down, work
                                with your hands, and reconnect with nature.
                            </p>
                        </div>
                        <div className="w-fit md:w-[500px]">
                            ...
                            <p className="text-[16px] md:text-[24px]">
                                ...
                                materials that transform small spaces into
                                living sanctuaries.
                            </p>
                        </div>
                    </div>
