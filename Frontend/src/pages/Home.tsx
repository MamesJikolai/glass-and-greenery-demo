...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full h-fit md:h-[600px] px-2.5 py-10 md:p-32">
        <div className="flex flex-col gap-8 w-fit md:w-[750px] h-full justify-center">
          <h1 className="font-medium drop-shadow-2xl">Bring the Forest Home</h1>
          <p className="text-[24px]">
            Create your own living world with premium terrarium kits and
            immersive, hands-on workshops—designed for calm, creativity, and
            connection.
          </p>
          <div className="flex flex-row justify-between md:justify-start gap-8 w-full">
      ...
      <div className="flex flex-col gap-8 md:gap-16 text-center bg-brand-500 text-neutral-100 w-full h-fit px-2.5 py-10 md:p-16">
        ...
        <div className="flex flex-row flex-wrap text-left md:text-center gap-y-8 md:gap-x-32 md:gap-y-16">
          <div className="w-fit md:w-[500px]">
            <h3>Not Just Plants. A Ritual.</h3>
            <p className="text-[16px] md:text-[24px]">
              At Glass & Greenery, we believe building a terrarium is more than
              a hobby—it's a moment of stillness in a fast-moving world. Every
              kit and workshop is designed to help you slow down, work with your
          ...
          <div className="w-fit md:w-[500px]">
            ...
            <p className="text-[16px] md:text-[24px]">
              Our terrariums feature ethically sourced, rare mosses and artisan
              hand-blown glass vessels—no plastic, no shortcuts. Just
              thoughtfully curated materials that transform small spaces into
              living sanctuaries.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-8 md:gap-16 items-center w-full h-fit px-2.5 py-10 md:p-32">
        ...
        <div className="flex flex-row flex-wrap gap-16 text-neutral-100">
          {experienceContent.map((item, index) => (
            ...
            >
              ...
              <ButtonAccent children={item.button} className="w-full" />
            </div>
          ))}
        </div>
      </div>

      <div className="flex flex-col gap-8 md:gap-16 bg-brand-500 text-neutral-100 w-full h-fit px-2.5 py-10 md:p-32">
        <h2>FAQ</h2>

        <div className="flex flex-col gap-8 w-full">
          {faqContent.map((item, index) => (
            <div key={index} className="bg-surface-primary p-8 rounded-4xl">
              <div className="flex flex-row justify-between items-center">
                <h3>{item.title}</h3>
                <div
                  className="bg-neutral-100 w-[32px] h-[32px]"
                  onClick={onToggle}
                ></div>
              </div>
